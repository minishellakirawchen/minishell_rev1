...
/*   Updated: 2023/02/04 18:08:34 by takira           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
/* FREE OK */
// TODO: Norminette
...
t_list_bdi	*get_last_splitted_node(t_token_elem *token_elem, t_list_bdi **prev, t_list_bdi **token_head)
{
	t_list_bdi		*splitted_list_head;
...
void	handle_tokens(t_token_elem **last_token, t_list_bdi **last_node, t_list_bdi **now_node, t_token_elem *token_elem)
{
