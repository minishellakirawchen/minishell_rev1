...
/*   Updated: 2023/02/02 09:32:39 by takira           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	validate_operator_list_token(t_token_type type, t_token_type next_type, bool *is_error, bool is_head);
static void	validate_pipeline_commands_token(t_token_type type, t_token_type next_type, bool *is_error, bool is_head);
static void	validate_subshell_token(t_token_type type, t_token_type next_type, bool *is_error, bool is_head);
...
static void	validate_subshell_token(t_token_type type, t_token_type next_type, bool *is_error, bool is_head)
{
	...
	if (type == e_subshell_end)
		...
		|| next_type == e_init)
			*is_error = true;
	if (type == e_init && next_type == e_subshell_start) //init=word
		*is_error = true;
}
